...
# For equation #1 (giraffe) make sure you understand the identification of beta 1 and 2.

## --- Percentages ---
## turn the proportion 0.250 into a percent:
.25 * 100              # hint: 0.250 * 100

## percent change when x goes 54 -> 57:
(54 - 57) / 54 * 100              # hint: (57 - 54) / 54 * 100
# ^ for this think of % change formula, ((new - old) / old) * 100
...
## (b) interest rate 3% -> 5%: percentage-POINT change = 2 ; percent change = 66.67%   (comment)
5 - 3
(5 -3) / 3 * 100

# Trump approval rating example: 
38 - 52
(52 - 38) / 52 * 100