...
colgpa <- function(hsgpa) {       # define colGPA as a function of hsGPA
  1.5 + 0.5 * hsgpa                          # the line:  b0 + b1*hsgpa
}
colgpa(3.1)                       # use it: predicted colGPA at hsGPA = 3.6   (-> 3.3)
colgpa = .5 * 1                            # how much does colGPA change from hsGPA 2.6 to 3.6?  (use colgpa)
